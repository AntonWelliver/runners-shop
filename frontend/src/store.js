...
import { orderCreateReducer, orderDetailsReducer, orderPayReducer, orderDeliverReducer, orderListReducer, fullOrderListReducer } from './reducers/orderReducers'
...
const reducer = combineReducers({
    ...
    fullOrderList: fullOrderListReducer
})
...
const shippingAddressFromStorage = localStorage.getItem('shippingAddress') ? JSON.parse(localStorage.getItem('shippingAddress')) : { address: '', city: '', postalCode: '', country: '' }
